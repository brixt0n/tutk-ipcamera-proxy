...
class AvIOCtrlMsgType(IntEnum):
    ...
    # Device Event Report Msg
    IOTYPE_USER_IPCAM_EVENT_REPORT = 0x1FFF 
    # Send from client, used to talk to device that client had received the 
    # first I frame
    ...
    IOTYPE_USER_IPCAM_SET_TIME = 0xF028
